...
public:
  ...
  /**
   * Return the BlockAckManager associated with this EdcaTxopN.
   *
   * \return BlockAckManager *
   */
  BlockAckManager * GetBaManager () const;
  ...
  void SetPrimaryQueue (Ptr<WifiMacQueue> queue);
